...
class GraphNode(template.Node):
	...
	def render(self, context):
		...
		'''
		try:
			divContainer = self._container.resolve(context)
		except template.VariableDoesNotExist:
			divContainer = str(self._container)
		return self.render.__doc__ % {'container': divContainer, 'data': self._data, 'options': self._options}
